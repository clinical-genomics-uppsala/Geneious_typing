...
| -------- | ------- | ------- |
| v0.4.0 | build from spatyper/spatyper.Dockerfile | spaTyper 1.0.0 |
| v0.4.0 | quay.io/biocontainers/krocus:1.0.3--pyhdfd78af_0 | krocus 1.0.3 |
| v0.4.0 | hydragenetics/common:3.1.1.1 | bedtools v2.31.1 | 
| v0.4.0 | hydragenetics/common:3.1.1.1 | xlsxwriter 3.2.3 | 
